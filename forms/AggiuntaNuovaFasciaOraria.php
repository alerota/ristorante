...
if(!isset($_COOKIE["login"])) {
    ...
    <div class="container">
        <hr>
        <div class="row">
            <form id="insertFO" method="POST"
                  action="<?php if ($_GET != null && isset($_GET['id'])) echo "../codici/update/updateFasciaOraria.php"; else echo "../codici/insert/insertFasciaOraria.php"; ?>">
                <div class="col-md-3">
                    <fieldset>
