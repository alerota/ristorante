...
if(!isset($_COOKIE["login"])) {
    ...
    <div class="container">
        ...
        <hr>
        <form method="POST"
              action="<?php if (isset($_GET['id'])) echo "../codici/update/updateGiornoSpeciale.php"; else echo "../codici/insert/insertGiornoSpeciale.php"; ?>"
              id="insertGS">
            <div class="row">
                <div class="col-md-3">
                    <fieldset>
                ...
                <div class="col-md-6">
                    ...
                    <button onclick="document.getElementById('insertGS').submit();" class="btn btn-primary center-block"
