						...
						<form method="POST" id="insertSL" action="codici/insertNuovaSala.php">
							<fieldset>
								...
								<div class="form-group">
									...
									<label></label>
									<input type="text" name="nomeSala" class="form-control" placeholder="Nome">
									...
									<label></label>
									<input type="number" name="numeroPosti" class="form-control" placeholder="Numero">
									<span class="help-block"></span>
								</div>
							</fieldset>
							<button onclick="document.getElementById('insertSL').submit();" class="btn btn-primary center-block" type="button" style="width: 100%; ">Inserisci</button>
						</form>
						<br>
						<style>
